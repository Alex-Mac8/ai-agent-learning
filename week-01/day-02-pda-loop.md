...
### Videos
- 🎥 [ReAct: Synergizing Reasoning and Acting in LLMs](https://www.youtube.com/watch?v=Eug2clsLtFs) — Sam Witteveen (20 min) — Excellent breakdown of the ReAct paper
- 🎥 [How AI Agents Work](https://www.youtube.com/watch?v=F8NKVhkZZWI) — AI Jason — Focus on the loop section (5:00-12:00)
- 🎥 [Building AI Agents from Scratch](https://www.youtube.com/watch?v=AxnL5GtWnGI) — Code with practical loop implementation
