...
### Videos
- 🎥 [LangSmith Debugging Tutorial](https://www.youtube.com/watch?v=tFXm5ijih98) — Visual agent tracing
- 🎥 [Testing LLM Applications](https://www.youtube.com/watch?v=2CIIQ5KZWKQ) — Testing strategies

### Reading
- 📄 [LangSmith Documentation](https://docs.smith.langchain.com/) — Full tracing guide
- 📄 [LangGraph Debugging Guide](https://langchain-ai.github.io/langgraph/how-tos/debugging/) — Debug LangGraph agents
