...
- 🎥 [Building Custom Tools in LangChain](https://www.youtube.com/watch?v=0lOSvOoF2to) — Sam Witteveen
- 🎥 [LangChain Tool Deep Dive](https://www.youtube.com/watch?v=AxnL5GtWnGI) — Code walkthrough

### Reading
- 📄 [LangChain: Custom Tools Guide](https://python.langchain.com/docs/how_to/custom_tools/) — Official documentation
