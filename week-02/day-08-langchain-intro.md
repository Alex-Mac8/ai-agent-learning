...
### Videos
- 🎥 [LangChain in 20 Minutes](https://www.youtube.com/watch?v=aywZrzNaKjs) — Quick overview
...
- 🎥 [Build an Agent from Scratch](https://www.youtube.com/watch?v=AxnL5GtWnGI) — Code walkthrough

### Reading
- 📄 [LangChain Python Docs](https://python.langchain.com/docs/get_started/introduction) — Official documentation
- 📄 [LangChain Concepts: Agents](https://python.langchain.com/docs/concepts/agents/) — Conceptual guide
- 📄 [LangGraph Quick Start](https://langchain-ai.github.io/langgraph/tutorials/introduction/) — Modern agent building
