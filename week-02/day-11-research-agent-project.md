...
### Videos
- 🎥 [Build a Research Agent with LangChain](https://www.youtube.com/watch?v=AxnL5GtWnGI) — Full code tutorial
- 🎥 [LangGraph Agent Tutorial](https://www.youtube.com/watch?v=bq1Plo2RhAc) — Building with LangGraph

### Reading
- 📄 [LangGraph: Build an Agent](https://langchain-ai.github.io/langgraph/tutorials/introduction/) — Official tutorial
