...
### Videos
- 🎥 [LangGraph Memory Tutorial](https://www.youtube.com/watch?v=bq1Plo2RhAc) — Official LangGraph persistence guide
- 🎥 [DeepLearning.AI: Agent Memory](https://www.deeplearning.ai/short-courses/ai-agents-in-langgraph/) — Memory lesson

### Reading
- 📄 [LangGraph: Persistence Guide](https://langchain-ai.github.io/langgraph/concepts/persistence/) — Official docs
